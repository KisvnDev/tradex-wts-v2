...
export interface LibrarySymbolInfo {
   ...
   * @example For example, U.S. equities are quotes in decimals, and tick in decimals, and can go up +/- .01. So the tick increment is 1. But the e-mini S&P derivatives contract, though quoted in decimals, goes up in .25 increments, so the tick increment is 25. (see also Tick Size)
   */
  minmov: number;
  fractional?: boolean;
  /**
  ...
  /**
   * Boolean showing whether this symbol is expired derivatives contract or not.
   */
  expired?: boolean;
  /**
